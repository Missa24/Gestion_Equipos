...
export const FormUsuario = ({
  ...
  const { data: roles } = useGetAllRoles({ limit: 100 });
      ...
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <FieldGroup>
            ...
            {/* ID Oficina / ID Rol */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput<UsuarioPayload, Oficina>
                name="id_oficina"
                control={form.control}
                label="Oficina"
                type="select"
