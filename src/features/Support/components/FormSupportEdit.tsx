...
import { Usuario } from "@/features/Usuarios";
...
export const FormSupportEdit = ({
  initialData,
  mode,
  onSuccess,
}: FormSupportEditProps) => {
  ...
  function onSubmit(values: SupportPayload) {
    if (mode === "edit" && initialData) {
      updateSupport(
        { id: initialData.id_soporte, data: values },
        { onSuccess: () => onSuccess?.() },
      );
    } else {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <FieldGroup>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput<SupportPayload, Usuario>
                name="id_usuario"
              ...
              <FormInput<SupportPayload, Usuario>
                ...
                type="select"
                placeholder="ingresa el tecnico"
                data={usuarios}
                valueKey="id_usuario"
                labelKey="nombres"
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput<SupportPayload, Equipo>
                name="id_equipo"
                control={form.control}
              ...
              />
              <FormInput<SupportPayload>
                name="resolucion"
                control={form.control}
                label="Resolucion"
                type="text"
                placeholder="Ingresa la resolucion dada"
              />
            </div>
